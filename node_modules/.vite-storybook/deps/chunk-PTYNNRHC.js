import {
  ...
  components,
  resetComponents
} from "./chunk-4LDJ3FQK.js";
import {
  ThemeProvider,
  ensure,
  styled
} from "./chunk-5647L55I.js";
import {
  str
...
import {
  require_lib
} from "./chunk-2IEUHLBE.js";
import {
  NAVIGATE_URL,
  esm_default as esm_default2
} from "./chunk-LK7TBICF.js";
import {
...
// .yarn/__virtual__/@storybook-components-virtual-b395365afd/0/cache/@storybook-components-npm-6.5.14-f0621adc55-73d0ff418f.zip/node_modules/@storybook/components/dist/esm/index.js
...
var AddContext = function AddContext2(props) {
  var children = props.children, rest = _objectWithoutProperties3(props, _excluded2);
...
var CodeOrSourceMdx = function CodeOrSourceMdx2(_ref) {
  var className = _ref.className, children = _ref.children, rest = _objectWithoutProperties3(_ref, _excluded22);
...
var AnchorMdx = function AnchorMdx2(props) {
  var href = props.href, target = props.target, children = props.children, rest = _objectWithoutProperties3(props, _excluded3);
  if (href) {
    if (href.startsWith("#")) {
...
var OcticonHeaders = SUPPORTED_MDX_HEADERS.reduce(function(acc, headerType) {
  return Object.assign({}, acc, _defineProperty5({}, headerType, styled(components[headerType])({
    "& svg": {
      visibility: "hidden"
    },
    "&:hover svg": {
...
var HeaderWithOcticonAnchor = function HeaderWithOcticonAnchor2(_ref3) {
  var as = _ref3.as, id = _ref3.id, children = _ref3.children, rest = _objectWithoutProperties3(_ref3, _excluded4);
...
var HeaderMdx = function HeaderMdx2(props) {
  var as = props.as, id = props.id, children = props.children, rest = _objectWithoutProperties3(props, _excluded5);
  if (id) {
...
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(function(acc, headerType) {
  return Object.assign({}, acc, _defineProperty5({}, headerType, function(props) {
...
//# sourceMappingURL=chunk-PTYNNRHC.js.map
